...
def test_simulation_evals_pass_rate() -> None:
    ...
    with patch.object(adapter, "is_available", return_value=True):
        with patch("auto_cxas_scrapi.adapters.cxas_evals.SimulationEvals", return_value=mock_client):
...
def test_tool_evals_aggregation() -> None:
    ...
    with patch.object(adapter, "is_available", return_value=True):
        with patch("auto_cxas_scrapi.adapters.cxas_evals.ToolEvals", return_value=mock_client):
...
def test_guardrail_evals_aggregation() -> None:
    ...
    with patch.object(adapter, "is_available", return_value=True):
        with patch("auto_cxas_scrapi.adapters.cxas_evals.GuardrailEvals", return_value=mock_client):
...
def test_turn_evals_aggregation() -> None:
    ...
    with patch.object(adapter, "is_available", return_value=True):
        with patch("auto_cxas_scrapi.adapters.cxas_evals.TurnEvals", return_value=mock_client):
...
def test_callback_evals_aggregation() -> None:
    ...
    with patch.object(adapter, "is_available", return_value=True):
        with patch("auto_cxas_scrapi.adapters.cxas_evals.CallbackEvals", return_value=mock_client):
